...
class Config {
  ...
  static const String base_url = 'https://event.surakshacode.com/';

  static const String api_url = '$base_url${'eapi'}/';

  static const String userImage = "$base_url/images/profile/pic.png";

  static const String firebaseKey = "AAAAYkf-5IY:APA91bHxi0ctYHu8RNNlWY_8iwBXrApBzXADZw7oism7hmEoEVEgktydN8uDuCRlqtVynBrleuGnm48e03No_NNkT_rNrLwQhbKJGNoeyhL1ZnqkS87cuBkI0E1vUJ5F6mJ5JDR4uAtr";
